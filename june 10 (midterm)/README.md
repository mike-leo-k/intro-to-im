...
* Programming the bullets in the jet's arsenal was also challenging, I was able to figure out how to make them disappear after a set amount of time and how to keep them travelling in the direction the jet was facing when it shot them, but I wasn't sure how to allow the jet to shoot more than a single bullet within a short span of time. This was resolved by creating an array of bullet objects with their own properties; while we did study this in class, [Dan Shiffman's tutorial](https://www.youtube.com/watch?v=am6e1U2BHkA) also proved extremely helpful in understand the concept further.
* I also wanted to incorporate reading data from csv files, so I programmed text to be read from a file containing a [list of random words](http://listofrandomwords.com/). These words are displayed on the play screen and change each time a bullet is shot.
* The portal mechanics were the hardest to figure out, and I've gone into much further depth in the comments in my code, but the general difficulties were ensuring the jet could not fly out of the screen anywhere other than where the portal was, changing its coordinates to the connected portal, but also making sure it exited the second portal at the right angle. Getting the portal to stick to the wall after being fired was easily done once I used conditionals.
